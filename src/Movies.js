...
const apiKey = 'd5ea30338fcc0bc31154f025b8a9d8ad'
// e4943bb541605c50d3877eebda6ea42c
        ...
        <div className="container" style={{marginTop:"50px"}}>
            <form>
                <div className="input-group mb-3">
                    <input type="text" name="searchTitle" onChange={handleChange} value={movieTitle}
                    className="form-control" placeholder="search your damn movies by title" />
                    <span>
